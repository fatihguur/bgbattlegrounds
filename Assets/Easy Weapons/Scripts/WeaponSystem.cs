...
public class WeaponSystem : MonoBehaviour
{
    ...
    public bool m4_alma = false;
    public bool shotgun_alma = false;
    public bool railgun_alma = false;
	...
	void Update()
	{
		...
		if (Input.GetButtonDown("Weapon 1"))
			SetActiveWeapon(0);
		if (Input.GetButtonDown("Weapon 2") && (m4_alma==true))
			SetActiveWeapon(1);
		if (Input.GetButtonDown("Weapon 3") && (shotgun_alma == true))
            SetActiveWeapon(2);
		if (Input.GetButtonDown("Weapon 4") && (railgun_alma == true))
            SetActiveWeapon(6);
